...
public enum Message implements ComponentLike {
    ...
    CLICK_TO_CREATE_COPY("Click to create copy", "Zum Anfertigen einer Kopie klicken"),
    ...
    CLICK_TO_CHANGE_NAME("Click to change name", "Zum Ändern des Namens klicken"),
    ...
    CREATION_TYPE("Creation Type", "Herkunft"),
    CRAFTING("Crafting", "Werkbank"),
    COMMAND("Command", "Befehl"),
    HOME("Home", "Schneckenzuhause"),
    ...
    SELECTOR_SELECTION_DESCRIPTION("Result of /sh select ...", "Ergebnis von /sh select ..."),
    ...
    DELETE_SHELL_SUCCESS("Successfully deleted {1} snail shell(s)", "{1} Schneckenhaus/-häuser erfolgreich gelöscht"),
    ...
    HOME_NOT_FOUND("Home not found", "Schneckenzuhause nicht gefunden"),
