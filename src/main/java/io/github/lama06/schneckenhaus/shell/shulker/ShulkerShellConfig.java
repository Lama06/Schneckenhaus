...
public final class ShulkerShellConfig extends SizedShellConfig {
    ...
    public void deserialize(Map<?, ?> config) {
        ...
        rainbowIngredient = ItemConfig.parse(config.get("rainbow_ingredient"));
    }
    ...
    protected void serialize(Map<String, Object> config) {
        ...
        config.put("rainbow_ingredient", rainbowIngredient == null ? null : rainbowIngredient.serialize());
    }
